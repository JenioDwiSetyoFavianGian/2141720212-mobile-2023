...
![Screenshoot tipedata](docs/prak1.1.png)

## Langkah 2:
Silakan coba eksekusi (Run) kode pada langkah 1 tersebut. Apa yang terjadi? Jelaskan!

![Screenshoot tipedata](docs/p1.1.png)

## Langkah 3:
Ubah kode pada langkah 1 menjadi variabel final yang mempunyai index = 5 dengan default value = null. Isilah nama dan NIM Anda pada elemen index ke-1 dan ke-2. Lalu print dan capture hasilnya.
Apa yang terjadi ? Jika terjadi error, silakan perbaiki.

![Screenshoot tipedata](docs/prak1.2.png)
...
![Screenshoot tipedata](docs/prak2.1.png)
...
![Screenshoot tipedata](docs/prak2.2.png)
...
![Screenshoot tipedata](docs\prak3.1.png)
...
![Screenshot](docs/prak4.3.png)

Oleh karena itu dilakukan perbaikan sebagaimana berikut

![Screenshot](docs/prak4.4.png)
...
![Screenshot](docs/prak5.4.png)

# 7. Tugas Praktikum

1. Jelaskan yang dimaksud Functions dalam bahasa Dart!

• Jawab : Function adalah sekumpulan blok kode yang dapat menerima input, melakukan komputasi atau proses, serta mengembalikan nilai (return).
...
• Jawab : Dalam bahasa Dart terdapat beberapa jenis parameter yang dapat digunakan dalam fungsi. Berikut beberapa jenis parameter yang umum digunakan beserta sintaksnya:
...
• Didefinisikan dalam tanda kurung kurawal {} sebagai bagian dari deklarasi fungsi. Penggunaan parameter ini memerlukan penamaan parameter saat memanggil fungsi.
...
• Jawab : Function sebagai first-class mengacu pada kemamapuan untuk memperlakukan fungsi seperti jenis data lainnya, seperti int, String, atau Objek. Ini berarti dalam bahasa pemrograman yang mendukung fungsi sebagai first-class objects, fungsi dapat digunakan sebagai variabel, parameter, serta return value.
...
- Jawab: Dalam Dart, Kita dapat membuat fungsi tanpa nama yang disebut anonymous function, lambda, atau closure. Anonymous function biasanya digunakan untuk operasi sekali pakai jika kita tidak menyimpannya kedalam sebuah variable ,dan sering digunakan untuk tugas-tugas sederhana atau sebagai argumen untuk fungsi lain.
...
• Jawab : Terdapat beberapa cara untuk melakukan return multiple value, salah satunya dengan maps.
